/**
 * ColorMethods.cpp is part of Brewken, and is copyright the following authors 2009-2014:
...
double ColorMethods::mcuToSrm(double mcu)
{
   switch( Brewken::colorFormula )
   {
      ...
      case Brewken::MOSHER:
         return mosher(mcu);
      default:
         qCritical() << QObject::tr("Invalid color formula type: %1").arg(Brewken::colorFormula);
         return morey(mcu);
   }
}
