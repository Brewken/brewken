/*======================================================================================================================
 * trees/TreeFilterProxyModel.cpp is part of Brewken, and is copyright the following authors 2009-2024:
...
///bool TreeFilterProxyModel::lessThan(QModelIndex const & left,
///                                    QModelIndex const & right) const {
///
///   TreeModel * model = qobject_cast<TreeModel *>(this->sourceModel());
