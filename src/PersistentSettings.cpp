/*======================================================================================================================
 * PersistentSettings.cpp is part of Brewken, and is copyright the following authors 2009-2026:
      ...
      userDataDir.setPath(
         ...
         PersistentSettings::value_ck(
            ...
            QStandardPaths::writableLocation(
               QStandardPaths::AppDataLocation // = Default for Brewken (AppConfigLocation for Brewtarget)
            )
         ).toString()
      );
   }
