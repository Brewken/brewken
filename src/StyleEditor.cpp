...
void StyleEditor::save() {
   ...
   this->obsStyle->setOgMin( lineEdit_ogMin->toSiRaw() );
   this->obsStyle->setOgMax( lineEdit_ogMax->toSiRaw() );
   this->obsStyle->setFgMin( lineEdit_fgMin->toSiRaw() );
   this->obsStyle->setFgMax( lineEdit_fgMax->toSiRaw() );
   this->obsStyle->setIbuMin( lineEdit_ibuMin->toSiRaw() );
   this->obsStyle->setIbuMax( lineEdit_ibuMax->toSiRaw() );
   this->obsStyle->setColorMin_srm( lineEdit_colorMin->toSiRaw() );
   this->obsStyle->setColorMax_srm( lineEdit_colorMax->toSiRaw() );
   this->obsStyle->setCarbMin_vol( lineEdit_carbMin->toSiRaw() );
   this->obsStyle->setCarbMax_vol( lineEdit_carbMax->toSiRaw() );
   this->obsStyle->setAbvMin_pct( lineEdit_abvMin->toSiRaw() );
   this->obsStyle->setAbvMax_pct( lineEdit_abvMax->toSiRaw() );
