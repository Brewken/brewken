...
class BtMassConcentrationEdit    : public BtLineEdit { Q_OBJECT public: BtMassConcentrationEdit  (QWidget* parent); };
class BtVolumeConcentrationEdit  : public BtLineEdit { Q_OBJECT public: BtVolumeConcentrationEdit(QWidget* parent); };
...
class BtMixedMassOrVolumeEdit : public BtLineEdit {
   Q_OBJECT
public:
