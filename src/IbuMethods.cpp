/**
 * IbuMethods.cpp is part of Brewken, and is copyright the following authors 2009-2014:
...
double IbuMethods::getIbus(double AArating, double hops_grams, double finalVolume_liters, double wort_grav, double minutes)
{
   switch( Brewken::ibuFormula )
   {
      ...
      case Brewken::NOONAN:
         ...
         break;
      default:
         qCritical() << QObject::tr("Unrecognized IBU formula type. %1").arg(Brewken::ibuFormula);
         return tinseth(AArating, hops_grams, finalVolume_liters, wort_grav, minutes);
         break;
   }
}
