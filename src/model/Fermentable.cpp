...
void Fermentable::setAmountWithUnits       (MassOrVolumeAmt           const   val) { this->setAndNotify(PropertyNames::Fermentable::amount                , this->m_amount                , val.quantity()                 ); // Continues to next line!
