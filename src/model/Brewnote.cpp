...
QString BrewNote::brewDate_short() const { return Brewken::displayDateUserFormated(m_brewDate.date()); }
...
QString BrewNote::fermentDate_short() const { return Brewken::displayDateUserFormated(m_fermentDate.date()); }
