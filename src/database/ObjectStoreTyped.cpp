...
namespace {
   ...
   template<> ObjectStore::TableDefinition const PRIMARY_TABLE<Equipment> {
      "equipment",
      {
         ...
         {ObjectStore::FieldType::Double, "mash_tun_specific_heat"       , PropertyNames::Equipment::mashTunSpecificHeat_calGC },
         {ObjectStore::FieldType::Double, "mash_tun_volume"              , PropertyNames::Equipment::mashTunVolume_l           },
         {ObjectStore::FieldType::Double, "mash_tun_weight"              , PropertyNames::Equipment::mashTunWeight_kg          },
      }
   };
