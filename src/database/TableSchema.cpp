...
void TableSchema::defineRecipeTable()
{
   ...
   m_properties[PropertyNames::Recipe::asstBrewer]  = new PropertySchema( PropertyNames::Recipe::asstBrewer,  kcolRecipeAsstBrewer,   kxmlPropAsstBrewer,   QString("text"), QString("'Brewken'"));
