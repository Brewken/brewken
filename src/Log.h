/**
 * Log.h is part of Brewken, and is copyright the following authors 2009-2020:
...
namespace Log
{
   ...
   */
    ...
    * the old way of calling the Brewken::LogX functions will persist, but will use this way of writing logs as well.
    ...
    * i.e. on linux: ~/.config/brewken or on Windows %APPDATA% path.
    */
