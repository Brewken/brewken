/**
 * BrewNoteWidget.cpp is part of Brewken, and is copyright the following authors 2009-2014:
...
void BrewNoteWidget::updateDateFormat(Unit::unitDisplay display,Unit::unitScale scale)
{
   ...
   Unit::unitDisplay unitDsp = (Unit::unitDisplay)Brewken::option(PropertyNames::BrewNote::fermentDate, Brewken::getDateFormat(), "page_postferment", Brewken::UNIT).toInt();
...
void BrewNoteWidget::updateProjOg(Unit::unitDisplay oldUnit, Unit::unitScale oldScale)
{
   ...
   Unit::unitDisplay unitDsp = (Unit::unitDisplay)Brewken::option(PropertyNames::BrewNote::projOg, Unit::noUnit, "page_preboil", Brewken::UNIT).toInt();
