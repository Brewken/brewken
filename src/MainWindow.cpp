...
void MainWindow::restoreSavedState()
{
   ...
   if ( Brewken::hasOption("geometry"))
   {
      restoreGeometry(Brewken::option("geometry").toByteArray());
      restoreState(Brewken::option("windowState").toByteArray());
   }
   else
   {
   ...
   if (Brewken::hasOption("recipeKey"))
   {
      int key = Brewken::option("recipeKey").toInt();
   ...
   //UI restore state
   if (Brewken::hasOption("MainWindow/splitter_vertical_State"))
      splitter_vertical->restoreState(Brewken::option("MainWindow/splitter_vertical_State").toByteArray());
   if (Brewken::hasOption("MainWindow/splitter_horizontal_State"))
      splitter_horizontal->restoreState(Brewken::option("MainWindow/splitter_horizontal_State").toByteArray());
   if (Brewken::hasOption("MainWindow/treeView_recipe_headerState"))
      treeView_recipe->header()->restoreState(Brewken::option("MainWindow/treeView_recipe_headerState").toByteArray());
   if (Brewken::hasOption("MainWindow/treeView_style_headerState"))
      treeView_style->header()->restoreState(Brewken::option("MainWindow/treeView_style_headerState").toByteArray());
   if (Brewken::hasOption("MainWindow/treeView_equip_headerState"))
      treeView_equip->header()->restoreState(Brewken::option("MainWindow/treeView_equip_headerState").toByteArray());
   if (Brewken::hasOption("MainWindow/treeView_ferm_headerState"))
      treeView_ferm->header()->restoreState(Brewken::option("MainWindow/treeView_ferm_headerState").toByteArray());
   if (Brewken::hasOption("MainWindow/treeView_hops_headerState"))
      treeView_hops->header()->restoreState(Brewken::option("MainWindow/treeView_hops_headerState").toByteArray());
   if (Brewken::hasOption("MainWindow/treeView_misc_headerState"))
      treeView_misc->header()->restoreState(Brewken::option("MainWindow/treeView_misc_headerState").toByteArray());
   if (Brewken::hasOption("MainWindow/treeView_yeast_headerState"))
      treeView_yeast->header()->restoreState(Brewken::option("MainWindow/treeView_yeast_headerState").toByteArray());
   if (Brewken::hasOption("MainWindow/mashStepTableWidget_headerState"))
      mashStepTableWidget->horizontalHeader()->restoreState(Brewken::option("MainWindow/mashStepTableWidget_headerState").toByteArray());
}
...
{
   Unit::unitDisplay dispUnit = static_cast<Unit::unitDisplay>(Brewken::option(attribute, Unit::noUnit, "tab_recipe", Brewken::UNIT).toInt());
...
void MainWindow::exportRecipe()
{
   ...
   QDomComment beerxml = doc.createComment(QString(" BeerXML generated by Brewken %1 ").arg(VERSIONSTRING));
...
void MainWindow::newRecipe()
{
   QString name = QInputDialog::getText(this, tr("Recipe name"),
                                          tr("Recipe name:"));
   QVariant defEquipKey = Brewken::option("defaultEquipmentKey", -1);
...
void MainWindow::closeEvent(QCloseEvent* /*event*/)
{
   ...
   Brewken::setOption("geometry", saveGeometry());
   Brewken::setOption("windowState", saveState());
   if ( recipeObs )
      Brewken::setOption("recipeKey", recipeObs->key());

   //UI save state
   Brewken::setOption("MainWindow/splitter_vertical_State", splitter_vertical->saveState());
   Brewken::setOption("MainWindow/splitter_horizontal_State", splitter_horizontal->saveState());
   Brewken::setOption("MainWindow/treeView_recipe_headerState", treeView_recipe->header()->saveState());
   Brewken::setOption("MainWindow/treeView_style_headerState", treeView_style->header()->saveState());
   Brewken::setOption("MainWindow/treeView_equip_headerState", treeView_equip->header()->saveState());
   Brewken::setOption("MainWindow/treeView_ferm_headerState", treeView_ferm->header()->saveState());
   Brewken::setOption("MainWindow/treeView_hops_headerState", treeView_hops->header()->saveState());
   Brewken::setOption("MainWindow/treeView_misc_headerState", treeView_misc->header()->saveState());
   Brewken::setOption("MainWindow/treeView_yeast_headerState", treeView_yeast->header()->saveState());
   Brewken::setOption("MainWindow/mashStepTableWidget_headerState", mashStepTableWidget->horizontalHeader()->saveState());
