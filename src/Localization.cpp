/*======================================================================================================================
 * Localization.cpp is part of Brewken, and is copyright the following authors 2011-2021:
...
void Localization::setLanguage(QString twoLetterLanguage) {
   ...
   QDir translations = QDir(Brewken::getResourceDir().canonicalPath() + "/translations_qm");
