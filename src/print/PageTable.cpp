/*======================================================================================================================
 * print/PageTable.cpp is part of Brewken, and is copyright the following authors 2021:
...
namespace Print {
   PageTable::PageTable(Page *parent,
                        PageText *th,
                        QList<QStringList> td,
                        QFont tableDataFont,
                        QFont *columnHeaderFont,
                        QPoint pos,
                        QRect rect) :
   ...
   PageTableStyle PageTable::getTableStyle() {
      return tableStyle;
   }
