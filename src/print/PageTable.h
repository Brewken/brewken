/*======================================================================================================================
 * print/PageTable.h is part of Brewken, and is copyright the following authors 2021:
 ...
 * <http://www.gnu.org/licenses/>.
 =====================================================================================================================*/
#ifndef PRINT_PAGETABLE_H
#define PRINT_PAGETABLE_H
#pragma once
...
#include "print/PageTableColumn.h"
...
namespace Print {
   ...
   public:
       ...
       */
      PageTable(Page *parent,
                PageText *th,
                QList<QStringList> td,
                QFont tableDataFont,
                QFont *columnHeaderFont = nullptr,
                QPoint pos = QPoint(),
                QRect rect = QRect());
