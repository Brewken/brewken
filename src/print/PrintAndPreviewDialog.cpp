/*======================================================================================================================
 * print/PrintAndPreviewDialog.cpp is part of Brewken, and is copyright the following authors 2021:
 ...
 * <http://www.gnu.org/licenses/>.
 =====================================================================================================================*/
#include "print/PrintAndPreviewDialog.h"
...
#include "print/InventoryFormatter.h"
 ...
 */
void PrintAndPreviewDialog::renderRecipe(Print::Page &page)
{
   using namespace Print;
   ...
   page.placeRelationalToMM(fermTable, statTable, Print::BELOW, 0, 5);
   ...
   page.placeRelationalToMM(hopsTable, fermTable, Print::BELOW, 0, 5);
   ...
   page.placeRelationalToMM(miscTable, hopsTable, Print::BELOW, 0, 5);
   ...
   page.placeRelationalToMM(yeastTable, miscTable, Print::BELOW, 0, 5);
   ...
   page.placeRelationalToMM(mashTable, yeastTable, Print::BELOW, 0, 5);
   ...
   page.placeRelationalToMM(notesHeader, mashTable, Print::BELOW, 0, 5);
   ...
   page.placeRelationalToMM(notesText, notesHeader, Print::BELOW);
   ...
   page.placeRelationalToMM(tasteNotesHeader, notesText, Print::BELOW, 0, 5);
   ...
   page.placeRelationalToMM(tasteNotesHeaderText, tasteNotesHeader, Print::BELOW);
}
 ...
 * @param page Page object to render content to.
 */
void PrintAndPreviewDialog::renderBrewdayInstructions(Print::Page &page)
{
   ...
   page.placeRelationalToMM(instructionsTable, statsTable, Print::BELOW, 0, 5);
}
 ...
 * @param page Page object to render content to.
 */
void PrintAndPreviewDialog::renderHeader(Print::Page &page)
{
   using namespace Print;
   ...
   page.placeRelationalToMM(brewerText, recipeText, Print::BELOW, 2, 0);

   //Adding the Brewken logo.
   ...
   page.placeOnPage(img, Print::TOP | Print::RIGHT);
}

void PrintAndPreviewDialog::renderInventory(Print::Page &page)
{
   using namespace Print;
   ...
   if (checkBox_inventoryAll->isChecked() || checkBox_inventoryFermentables->isChecked())
   {
      fermentables = page.addChildObject(new PageTable (
         ...
         InventoryFormatter::createInventoryList<Fermentable>(Brewken::DBTable::FERMTABLE)
      ));
   ...
   if (checkBox_inventoryAll->isChecked() || checkBox_inventoryHops->isChecked())
   {
      hops = page.addChildObject(new PageTable (
         &page,
         QString("Hops"),
         InventoryFormatter::createInventoryList<Hop>(Brewken::DBTable::HOPTABLE)
      ));
   ...
   if (checkBox_inventoryAll->isChecked() || checkBox_inventoryYeast->isChecked())
   {
      yeasts = page.addChildObject(new PageTable (
         &page,
         QString("Yeast"),
         InventoryFormatter::createInventoryList<Yeast>(Brewken::DBTable::YEASTTABLE)
      ));
   ...
   if (checkBox_inventoryAll->isChecked() || checkBox_inventoryMicellaneous->isChecked())
   {
      miscs = page.addChildObject(new PageTable (
         ...
         InventoryFormatter::createInventoryList<Misc>(Brewken::DBTable::MISCTABLE)
      ));
