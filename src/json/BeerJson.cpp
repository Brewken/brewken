...
//      JsonRecordDefinition::create< JsonRecipRecord >,
   ...
   // the schema won out over precision.  Where possible simply ignore the field permutations that don't seem to make
   // sense (eg grain_absorption_rate on Hot Liquor Tank).  However, note that some fields are required on all vessels,
   // in particular "loss" and "maximum_volume".
   /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   template<> JsonRecordDefinition const BEER_JSON_RECORD_DEFINITION<Equipment> {
      ...
      JsonRecordDefinition::create< JsonNamedEntityRecord< Equipment > >,
      {
         ...
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"HLT\"]/grain_absorption_rate"             , BtString::NULL_STR                                   , &BEER_JSON_SPECIFIC_VOLUME_UNIT_MAPPER}, // Assume meaningless for HLT.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"HLT\"]/boil_rate_per_hour"                , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume meaningless for HLT.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"HLT\"]/drain_rate_per_minute"             , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume unimportant for HLT.  Not implemented.
         ...
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Mash Tun\"]/boil_rate_per_hour"           , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume meaningless for Mash Tun.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Mash Tun\"]/drain_rate_per_minute"        , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume meaningless for Mash Tun.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Mash Tun\"]/weight"                       , PropertyNames::Equipment::mashTunWeight_kg           , &BEER_JSON_MASS_UNIT_MAPPER           }, // Assume unimportant for Mash Tun.  Not implemented.
         ...
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Lauter Tun\"]/loss"                       , PropertyNames::Equipment::lauterDeadspaceLoss_l      , &BEER_JSON_VOLUME_UNIT_MAPPER         },
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Lauter Tun\"]/grain_absorption_rate"      , BtString::NULL_STR                                   , &BEER_JSON_SPECIFIC_VOLUME_UNIT_MAPPER}, // Assume meaningless for Lauter Tun.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Lauter Tun\"]/boil_rate_per_hour"         , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume meaningless for Lauter Tun.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Lauter Tun\"]/drain_rate_per_minute"      , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume unimportant for Lauter Tun.  Not implemented.
         ...
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Brew Kettle\"]/grain_absorption_rate"     , BtString::NULL_STR                                   , &BEER_JSON_SPECIFIC_VOLUME_UNIT_MAPPER}, // Assume meaningless for Kettle.  Not implemented.
         ...
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Fermenter\"]/grain_absorption_rate"       , BtString::NULL_STR                                   , &BEER_JSON_SPECIFIC_VOLUME_UNIT_MAPPER}, // Assume meaningless for Fermenter.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Fermenter\"]/boil_rate_per_hour"          , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume meaningless for Fermenter.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Fermenter\"]/drain_rate_per_minute"       , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume unimportant for Fermenter.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Fermenter\"]/weight"                      , BtString::NULL_STR                                   , &BEER_JSON_MASS_UNIT_MAPPER           }, // Assume unimportant for Fermenter.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Fermenter\"]/specific_heat"               , BtString::NULL_STR                                   , &BEER_JSON_SPECIFIC_HEAT_UNIT_MAPPER  }, // Assume unimportant for Fermenter.  Not implemented.
         ...
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Aging Vessel\"]/grain_absorption_rate"    , BtString::NULL_STR                                   , &BEER_JSON_SPECIFIC_VOLUME_UNIT_MAPPER}, // Assume meaningless for Aging Vessel.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Aging Vessel\"]/boil_rate_per_hour"       , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume meaningless for Aging Vessel.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Aging Vessel\"]/drain_rate_per_minute"    , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume unimportant for Aging Vessel.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Aging Vessel\"]/weight"                   , BtString::NULL_STR                                   , &BEER_JSON_MASS_UNIT_MAPPER           }, // Assume unimportant for Aging Vessel.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Aging Vessel\"]/specific_heat"            , BtString::NULL_STR                                   , &BEER_JSON_SPECIFIC_HEAT_UNIT_MAPPER  }, // Assume unimportant for Aging Vessel.  Not implemented.
         ...
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Packaging Vessel\"]/grain_absorption_rate", BtString::NULL_STR                                   , &BEER_JSON_SPECIFIC_VOLUME_UNIT_MAPPER}, // Assume meaningless for Packaging Vessel.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Packaging Vessel\"]/boil_rate_per_hour"   , BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume meaningless for Packaging Vessel.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Packaging Vessel\"]/drain_rate_per_minute", BtString::NULL_STR                                   , &BEER_JSON_VOLUME_UNIT_MAPPER         }, // Assume unimportant for Packaging Vessel.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Packaging Vessel\"]/weight"               , BtString::NULL_STR                                   , &BEER_JSON_MASS_UNIT_MAPPER           }, // Assume unimportant for Packaging Vessel.  Not implemented.
         {JsonRecordDefinition::FieldType::MeasurementWithUnits, "equipment_items[form=\"Packaging Vessel\"]/specific_heat"        , BtString::NULL_STR                                   , &BEER_JSON_SPECIFIC_HEAT_UNIT_MAPPER  }, // Assume unimportant for Packaging Vessel.  Not implemented.
